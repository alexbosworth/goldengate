...
const method = require('./../../funding/get_funded_transaction');
...
const tests = [
  {
    ...
    error: [400, 'ExpectedAskFunctionToGetFundedTransaction'],
  },
  {
  ...
  },
  {
    ...
    description: 'Funding outputs are required.',
    error: [400, 'ExpectedArrayOfOutputsToGetFundedTransaction'],
  },
  {
    args: makeArgs({}),
    description: 'Got funded transaction',
    expected: {
  ...
  {
    args: makeArgs({is_external: false}),
    description: 'Got internally funded transaction',
    expected: {
